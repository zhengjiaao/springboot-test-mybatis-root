...
import com.zja.service.IStudentServiceImpl;
...
@Api(tags = {"MybatisPlusController"}, description = "mybatis-plus简单测试")
public class MybatisPlusController {
    ...
    @GetMapping("get/like")
    @ApiOperation(value = "根据条件构造器模糊获取数据", notes = "获取数据", httpMethod = "GET")
    public Object likeName(@RequestParam String username) {
